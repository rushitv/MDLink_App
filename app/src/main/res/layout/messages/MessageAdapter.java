...
public class MessageAdapter extends BaseAdapter {
  ...
  private List<com.twilio.twiliochat.chat.messages.ChatMessage> messages;
  ...
  public void addMessage(Message message) {
    messages.add(new com.twilio.twiliochat.chat.messages.UserMessage(message));
    notifyDataSetChanged();
  }

  public void addStatusMessage(com.twilio.twiliochat.chat.messages.StatusMessage message) {
  ...
  private List<com.twilio.twiliochat.chat.messages.ChatMessage> convertTwilioMessages(List<Message> messages) {
    List<com.twilio.twiliochat.chat.messages.ChatMessage> chatMessages = new ArrayList<>();
    for (Message message : messages) {
      chatMessages.add(new com.twilio.twiliochat.chat.messages.UserMessage(message));
    }
    return chatMessages;
  }
  ...
  public View getView(int position, View convertView, ViewGroup viewGroup) {
    ...
    switch (type) {
      case TYPE_MESSAGE:
        ...
        com.twilio.twiliochat.chat.messages.ChatMessage message = messages.get(position);
        ...
        textViewDate.setText(com.twilio.twiliochat.chat.messages.DateFormatter.getFormattedDateFromISOString(message.getDateCreated()));
        break;
      case TYPE_STATUS:
        res = R.layout.status_message;
        convertView = layoutInflater.inflate(res, viewGroup, false);
        com.twilio.twiliochat.chat.messages.ChatMessage status = messages.get(position);

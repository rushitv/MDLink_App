...
import com.mdlink.R;
import com.mdlink.voice.SoundPoolManager;
...
public class VoiceFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.d(TAG, "Bundle data: " + remoteMessage.getData().get("title"));
        Log.d(TAG, "Bundle data: " + remoteMessage.getData().get("body"));
